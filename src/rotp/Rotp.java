...
public class Rotp {
    ...
    public static String jarFileName = "RotP-2.12a_modnar_MOD22_newRaces"+RotpGovernor.miniSuffix()+".jar";
    private static String jarPath;
    private static JFrame frame;
    public static String releaseId = "Beta 2.12a modnar_MOD22_newRaces";

...
public class Rotp {
    ...
    public static String jarFileName = "RotP-2.10_modnar_MOD20b_newRaces"+RotpGovernor.miniSuffix()+".jar";
    private static String jarPath;
    private static JFrame frame;
    public static String releaseId = "Beta 2.10 modnar_MOD20b_newRaces";

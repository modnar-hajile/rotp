...
public class Rotp {
    ...
    public static String jarFileName = "RotP-2.11_modnar_MOD21_newRaces"+RotpGovernor.miniSuffix()+".jar";
    private static String jarPath;
    private static JFrame frame;
    public static String releaseId = "Beta 2.11 modnar_MOD21_newRaces";

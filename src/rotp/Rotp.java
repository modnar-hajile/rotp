...
public class Rotp {
    ...
    public static String jarFileName = "RotP-2.16a_modnar_MOD26_newRaces"+RotpGovernor.miniSuffix()+".jar";
    public static boolean countWords = false;
    private static String jarPath;
    private static JFrame frame;
    public static String releaseId = "Beta 2.16a modnar_MOD26_newRaces";

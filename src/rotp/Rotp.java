...
public class Rotp {
    ...
    public static String jarFileName = "RotP-2.15a_modnar_MOD25_newRaces"+RotpGovernor.miniSuffix()+".jar";
    public static boolean countWords = false;
    private static String jarPath;
    private static JFrame frame;
    public static String releaseId = "Beta 2.15a modnar_MOD25_newRaces";

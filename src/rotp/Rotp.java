...
public class Rotp {
    ...
    public static String jarFileName = "RotP-2.12_modnar_MOD22_newRaces"+RotpGovernor.miniSuffix()+".jar";
    private static String jarPath;
    private static JFrame frame;
    public static String releaseId = "Beta 2.12 modnar_MOD22_newRaces";

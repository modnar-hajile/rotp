...
public class Rotp {
    ...
    public static String jarFileName = "RotP-2.14_modnar_MOD24_newRaces"+RotpGovernor.miniSuffix()+".jar";
    public static boolean countWords = false;
    private static String jarPath;
    private static JFrame frame;
    public static String releaseId = "Beta 2.14 modnar_MOD24_newRaces";

...
public class Rotp {
    ...
    public static String jarFileName = "RotP-2.17_modnar_MOD28_newRaces"+RotpGovernor.miniSuffix()+".jar";
    public static boolean countWords = false;
    private static String jarPath;
    private static JFrame frame;
    public static String releaseId = "Beta 2.17 modnar_MOD28_newRaces";

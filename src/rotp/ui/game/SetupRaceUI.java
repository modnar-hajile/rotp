...
public final class SetupRaceUI extends BasePanel implements MouseListener, MouseMotionListener {
    ...
    public void paintComponent(Graphics g0) {
        ...
        homeWorld.setLocation(x, y-scaled(105));
        ...
        homeWorldBox.setBounds(x-s1, y-scaled(105), FIELD_W+s2, FIELD_H+s2);
    ...
    private void initBackImg() {
        ...
        g.fillRect(scaled(125), s95, scaled(905), scaled(515));
        ...
        g.fillRect(scaled(815), scaled(110), scaled(200), scaled(485));

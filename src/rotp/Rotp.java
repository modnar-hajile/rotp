...
public class Rotp {
    ...
    public static String jarFileName = "RotP-2.13a_modnar_MOD23_newRaces"+RotpGovernor.miniSuffix()+".jar";
    public static boolean countWords = false;
    private static String jarPath;
    private static JFrame frame;
    public static String releaseId = "Beta 2.13a modnar_MOD23_newRaces";
